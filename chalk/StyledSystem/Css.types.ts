import { Dictionary, Omit } from "../Utils"
import {
   PropertiesFallback,
   Property,
...
type CSSProperties = StandardProperties<number | string> & SvgProperties<number | string>
