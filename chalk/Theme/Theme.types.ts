...
export interface ThemeComponentProps<Theme extends ChalkTheme = ChalkTheme>
   extends Dict,
...
export type ThemeComponentFunction<Style,
   Theme extends ChalkTheme = ChalkTheme> = (props: ThemeComponentProps<Theme>) => Style

export type ThemingPropsThunk<Style, Theme extends ChalkTheme = ChalkTheme> =
   | Style
...
export interface ChalkTheme extends Foundations {
