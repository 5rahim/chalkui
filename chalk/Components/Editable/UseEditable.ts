...
export function useEditable(props: UseEditableProps = {}) {
   ...
   const previewRef: any = useRef<any>(null)
   ...
   const getPreviewProps: any = useCallback(
      (props: any = {}, ref = null) => {
   ...
   const getInputProps: any = useCallback(
      (props: any = {}, ref = null) => ({
         ...props,
         hidden: !isEditing,
         placeholder,
   ...
   const getEditButtonProps: any = useCallback(
      (props: any = {}, ref = null) => ({
         "aria-label": "Edit",
         ...props,
         type: "button",
   ...
   const getSubmitButtonProps: any = useCallback(
      (props: any = {}, ref = null) => ({
         ...props,
         "aria-label": "Submit",
   ...
   const getCancelButtonProps: any = useCallback(
      (props: any = {}, ref = null) => ({
         "aria-label": "Cancel",
         id: "cancel",
         ...props,
